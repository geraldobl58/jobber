...
import org.geraldoluiz.jobber.modules.authentication.useCases.AuthCandidateUseCase;
...
@RestController
@RequestMapping("/auth")
@Tag(name = "Autenticação", description = "Operações relacionadas à autenticação de candidatos")
class AuthCandidateController {
    ...
    @Operation(summary = "Realiza login", description = "Realiza login de um candidato na plataforma")
    @ApiResponses({
